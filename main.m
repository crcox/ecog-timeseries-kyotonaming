...
vt_electrode_labels = strtrim(string(ELECTRODE{subject_index}));
plot_all_electrodes_ts(ECOG.namingERP_data_Pt02, tags, vt_electrode_labels, config);
...
vt_electrode_labels = strtrim(string(ELECTRODE{subject_index}));
plot_all_electrodes_ts(ECOG.namingERP_data_Pt03, tags, vt_electrode_labels, config);
...
vt_electrode_labels = strtrim(string(ELECTRODE{subject_index}));
plot_all_electrodes_ts(ECOG.Pt04_namingERP, tags, vt_electrode_labels, config);
...
vt_electrode_labels = strtrim(string(ELECTRODE{subject_index}));
plot_all_electrodes_ts(ECOG.namingERP_data_Pt05, tags, vt_electrode_labels, config);
...
vt_electrode_labels = strtrim(string(ELECTRODE{subject_index}));
plot_all_electrodes_ts(ECOG.Pt06_namingERP_anony, tags, vt_electrode_labels, config);
...
vt_electrode_labels = strtrim(string(ELECTRODE{subject_index}));
plot_all_electrodes_ts(ECOG.namingERPdataPt07, tags, vt_electrode_labels, config);
...
vt_electrode_labels = strtrim(string(ELECTRODE{subject_index}));
plot_all_electrodes_ts(ECOG.namingERPdataPt08, tags, vt_electrode_labels, config);
...
vt_electrode_labels = strtrim(string(ELECTRODE{subject_index}));
plot_all_electrodes_ts(ECOG.namingERPdataPt09, tags, vt_electrode_labels, config);
...
vt_electrode_labels = strtrim(string(ELECTRODE{subject_index}));
plot_all_electrodes_ts(ECOG.namingERPdataPt10, tags, vt_electrode_labels, config);
